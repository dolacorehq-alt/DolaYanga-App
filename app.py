...
TRANSLATIONS = {
    "en": {
        ...
        "add_first_help": "Use the form above to add your first transaction.",
...
If you have questions about these Terms, contact: dolacorehq@gmail.com""",
    ...
    "ny": {
        ...
        "add_first_help": "Gwiritsani ntchito fomu yomwe ili pamwambapa kuti mulembetse transaction yanu yoyamba.",
            ...
            try:
                ...
                if users:
                    ...
                    if st.button(t("delete_user_account"), use_container_width=True):
                        selected_user = {"id": selected_user_id}
